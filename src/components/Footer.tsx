                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-sm text-zinc-300">
                            Rejoignez la communauté Aurum Cartel et développez vos compétences en trading avec des
                            experts passionnés.
                        </p>
                    </div>
                    ...
                    {/* Quick Links */}
                    <div>
                        <h3 className="text-lg font-semibold mb-4 text-[#D4AF37]">Liens Rapides</h3>
                        <ul className="space-y-2">
                            <li>
                                <Link href="/pages/home" className="text-zinc-300 hover:text-[#D4AF37] transition">
                                    Accueil
                                </Link>
                            </li>
                            <li>
                                <Link href="/pages/cours" className="text-zinc-300 hover:text-[#D4AF37] transition">
                                    Nos Cours
                                </Link>
                            </li>
                            <li>
                                <Link href="/pages/messagerie"
                    ...
                    {/* Newsletter & Social */}
                    <div>
                        <h3 className="text-lg font-semibold mb-4 text-[#D4AF37]">Rejoignez-nous</h3>
                        <p className="text-sm text-zinc-300 mb-4">
                            Ensemble pour atteindre nos objectifs
                        </p>
                        <button
                            className="w-full bg-transparent text-white border-2 border-[#D4AF37] font-semibold py-2 px-6 rounded-full hover:bg-[#D4AF37] hover:text-black transition-all duration-300 mb-6">
                            Contactez-nous
                        </button>
